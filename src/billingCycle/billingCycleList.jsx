...
import { getList, showUpdate, showDelete, copyBillingCycle } from "./billingCycleActions";
      ...
      <tr key={x._id}>
        ...
        <td>
          ...
          <button
            ...
            onClick={() => this.handleCopy(x._id)} // Passa o ID do ciclo de pagamento para a função handleCopy
          >
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators({ getList, showUpdate, showDelete, copyBillingCycle }, dispatch);
